const mnText = {
  appbar: {
    ...
    logout: 'Гарах',
    links: {
      general: ['Нүүр', 'Үнэт эдлэл', 'Машин', 'Уран зураг'],
    },
  ...
  contactUs: {
    ...
    title2: 'Санал хүсэлт',
    address:
      'Монгол улс, Улаанбаатар хот, Чингэлтэй дүүрэг, 5-р хороо, Оранж плаза, 701 тоот',
    subtitle: 'Санал хүсэлт, гомдол',
    subtitle2:
      'Танд манай группийн бүтээгдэхүүн, үйлчилгээтэй холбоотой санал хүсэлт, гомдол байвал бидэнд бичиж үлдээнэ үү.',
    submit: 'Илгээх',
    name: 'Таны нэр',
    phone: 'Утасны дугаар',
    email: 'Имэйл хаяг',
