          ...
          <div className={classes.memberContantainer} >
              <div className={classes.memberContantainerCenter}>
                  ...
                  <div className={classes.friendColumn}>
                      <Friend name="Temuujin" img={Avatar} rate="4.5" button={<div className={classes.deleteBtn}>Delete</div>}/>
                      <Friend name="Temuujin" img={Avatar} rate="4.5" button={<div><div className={classes.acceptBtn}>Accept</div><div className={classes.deleteBtn}>Decline</div></div>}/>
                   </div>  
              </div>  
          </div>  
        </div>
