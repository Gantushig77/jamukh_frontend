          ...
          <div className={classes.row1}>
            <div className={classes.textContainer}>
              ...
              <div className={classes.avatar}>
                <img src={Avatar} className={classes.avatarImg} alt={'seperate avatar'} />
              </div>
              <Typography className={classes.title}>{props?.title}</Typography>
              <Typography className={classes.email}>{props?.email}</Typography>
              <div className={classes.row}>
                <div className={classes.column}>
                  <img src={Sale} className={classes.icons} alt={'sale'} />
                  <div className={classes.saleText}>My sales</div>
                  <div className={classes.saleCount}>12</div>
                </div>
                <div className={classes.column}>
                  <img src={Members} className={classes.icons} alt={'member'} />
                  <div className={classes.saleText}>Members</div>
                  <div className={classes.saleCount}>12</div>
                </div>
                <div className={classes.column}>
                  <img src={Rate} className={classes.icons} alt={'rate'} />
                  <div className={classes.saleText}>My rate</div>
                  <div className={classes.saleCount}>12</div>
                </div>
                <div className={classes.column}>
                  <img src={Heart} className={classes.icons} alt={'heart'} />
            ...
            <div className={classes.memberContainer}>
              ...
              <div className={classes.memberSmallProfiles}>
                ...
                <div className={classes.smallProfile}>
                  <div className={classes.smallProfileAvatar}>
                    <img alt={'avatar 3'} src={Avatar} className={classes.avatarImage} />
                    <div className={classes.smallProfileTitle}>Gantulga</div>
                    <div className={classes.smallProfileRank}>
                      <StarIcon className={classes.starRank} />
                      4.6
                ...
                <div className={classes.smallProfile}>
                  <div className={classes.smallProfileAvatar}>
                    <img alt={'avatar 22'} src={Avatar} className={classes.avatarImage} />
                    <div className={classes.smallProfileTitle}>Gantulga</div>
                    <div className={classes.smallProfileRank}>
                      <StarIcon className={classes.starRank} />
                      4.6
          ...
          <div className={classes.membersAdvantageContaint}>
            ...
            <div className={classes.membersTextContainer}>
              ...
              <div className={classes.membersDescription}>
                ...
                who will live in the house. Feng shui, originally a Chinese method of
                moving houses according to such factors as rain and micro- climates, has
                recently expanded its scope to address the design of interior spaces, with
                a view to promoting harmonious effects on the people living inside the
                house, although no actual effect has ever…
              </div>
              <div className={classes.membersButtonContainer}>
                <div className={classes.membersButton}>SEE ALL</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className={classes.aboutContainer}>
            ...
            <div className={classes.aboutMe}>
              ...
              <div className={classes.aboutMeDescription}>
                ...
                recently expanded its scope to address the design of interior spaces, with
                a view to promoting harmonious effects on the people living inside the
                house, although no actual effect has ever been demonstrated. Feng shui can
                also mean the “aura” in or around a dwelling, making it comparable to the
                real estate sales concept of “indoor-outdoor flow”.
              </div>
            </div>
          </div>
          <div className={classes.aboutCv}>
            <div className={classes.aboutMeTitle}>CV</div>
