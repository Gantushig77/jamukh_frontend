    ...
    <div className={classes.root}>
      ...
      <div className={classes.container}>
        <div className={classes.tabs}>
          <div
            className={tab === 'Эртний эдлэл' ? classes.activeTab : classes.tab}
            onClick={() => {
              setTab('Эртний эдлэл');
            }}
          >
          ...
          <div
            className={tab === 'Үл хөдлөх' ? classes.activeTab : classes.tab}
            onClick={() => {
              setTab('Үл хөдлөх');
            }}
          >
          ...
          <div
            className={tab === 'Машин' ? classes.activeTab : classes.tab}
            onClick={() => {
              setTab('Машин');
            }}
          >
          ...
          <div
            className={tab === 'Газар' ? classes.activeTab : classes.tab}
            onClick={() => {
              setTab('Газар');
            }}
          >
          ...
          <div
            className={tab === 'Уран зураг' ? classes.activeTab : classes.tab}
            onClick={() => {
              setTab('Уран зураг');
            }}
          >
        ...
        <div className={classes.categoryInfo}>Категорио сонгоно уу</div>
