...
export default function Property(props) {
  ...
  const formDataUpdateAds = () => {
    ...
    if (
      ...
      const info = {
        ...
        'ads_info': [
          { 'label': 'Өрөөний тоо', 'value': room_count },
          { 'label': 'Граж', 'value': has_garage },
          { 'label': 'Дүүрэг', 'value': district },
          { 'label': 'Байршил', 'value': address },
          { 'label': 'Талбай км2', 'value': size_mk },
          { 'label': 'Тагт', 'value': balcony_count },
          { 'label': 'Хаалга', 'value': door_type },
          { 'label': 'Цонх', 'value': wind_type },
          { 'label': 'Цонхны тоо', 'value': wind_count },
          { 'label': 'Шал', 'value': floor_type },
          { 'label': 'Хэдэн давхар', 'value': floor_count },
          { 'label': 'Барилгын давхар', 'value': building_level },
  ...
  return (
    <div className={classes.root}>
      ...
      <div className={classes.row}>
        <div className={classes.width30L}>Өрөөний тоо</div>
        <div className={classes.width40}>
      ...
      <div className={classes.row}>
        <div className={classes.width30L}>Граж</div>
        <div className={classes.width40}>
          <FormControl fullWidth className={classes.level}>
            <Select
              labelId='demo-simple-select-label'
      ...
      <div className={classes.row}>
        <div className={classes.width30L}>Тагт</div>
        <div className={classes.width40}>
          <FormControl fullWidth className={classes.level}>
            <Select
              labelId='demo-simple-select-label'
              ...
              onChange={(e) => {
                setbalcony_count(e.target.value);
              }}
              MenuProps={{
                PaperProps: {
                  style: {
      ...
      <div className={classes.row}>
        <div className={classes.width30L}>Талбай m2</div>
        <div className={classes.width40}>
          <InputBase
            type='number'
            value={size_mk}
      ...
      <div className={classes.row}>
        <div className={classes.width30L}>Цонх</div>
        <div className={classes.width40}>
          <FormControl fullWidth className={classes.level}>
            <Select
              labelId='demo-simple-select-label'
      ...
      <div className={classes.row}>
        <div className={classes.width30L}>Цонхны тоо</div>
        <div className={classes.width40}>
          <FormControl fullWidth className={classes.level}>
            <Select
              labelId='demo-simple-select-label'
      ...
      <div className={classes.row}>
        <div className={classes.width30L}>Шал</div>
        <div className={classes.width40}>
          <FormControl fullWidth className={classes.level}>
            <Select
              labelId='demo-simple-select-label'
      ...
      <div className={classes.row}>
        <div className={classes.width30L}>Хэдэн давхар</div>
        <div className={classes.width40}>
          <InputBase
            type='number'
            value={floor_count}
      ...
      <div className={classes.row}>
        <div className={classes.width30L}>Барилгын давхар</div>
        <div className={classes.width40}>
          <InputBase
            type='number'
      ...
      {/* //commission_date*/}
      <div className={classes.row}>
        <div className={classes.width30L}>Ашиглалтанд орсон он</div>
        <div className={classes.width40}>
          <InputBase
            type='number'
