...
const formDataUpdateAds = () => {
  setisLoading(true)
  if(artist_name===''||condition===''||price===''||description===''||files.length === 0){
   ...
   setisLoading(false)
    ...
    const info ={"title":title,"category":category,"description":description,'price':price,'currency_symbol':priceSymbol,'ads_info':[{'label':'Зураачын нэр','value':condition},{'label':'Зураачын нэр','value':artist_name}]}
